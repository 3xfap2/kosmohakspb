        ...
        {deadline.baseline_shortage_t <= 1e-6 ? (
          ...
          <>
            ...
            <p className="muted small-text">
              Строки 2035–2038 совпадают не по ошибке: дефицит в этом сценарии возникает только с 2038 года, поэтому
              узнать об ухудшении раньше 2038-го — значит получить один и тот же набор доступных решений. Точка невозврата — это не срок поставки сам по себе, а комбинация срока и свободной мощности канала: к
